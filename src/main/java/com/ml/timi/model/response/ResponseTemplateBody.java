...
public class ResponseTemplateBody {
    ...
    public ResponseTemplateBody() {

    }

    public ResponseTemplateBody(String batchId, String postBackStatus, int postBackCount, int postBackSuccessCount, int postBackErrorCount, List<Object> objectList) {
